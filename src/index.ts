...
export const stemAchievementsData: DataPackage = {
  ...
  people: [
    ...
    {
      id: 'lin-lanying',
      fullName: '林兰英 / Lin Lanying',
      preferredName: 'Lín Lányīng',
      dateOfBirth: new Date('1918-02-07'),
      pronouns: 'she/her',
      bio: "Lin Lanying was a Chinese semiconductor physicist whose work on monocrystalline silicon and gallium arsenide laid the material foundations for the country's microelectronics industry. After completing a PhD at Pennsylvania State University, she returned to China in 1957 and joined the Institute of Semiconductors at the Chinese Academy of Sciences, where she led the first domestic growth of monocrystalline silicon, gallium arsenide, and gallium phosphide. She extended her work to space-grown crystals on a Chinese recoverable satellite in the 1980s, demonstrating microgravity effects on semiconductor materials. She was elected to the Chinese Academy of Sciences and became one of the country's most cited materials scientists.",
    ...
    },
    {
      ...
      pronouns: 'she/her',
      bio: 'Tebello Nyokong is a Lesotho-born South African chemist whose research on metallophthalocyanines has advanced photodynamic therapy as a less-invasive cancer treatment. Based at Rhodes University in Makhanda, her group has investigated how light-activated dyes can selectively destroy tumour cells, with applications also extending to environmental remediation and sensor design. She received the African Union Kwame Nkrumah Award for Scientific Excellence in 2009 and the National Order of Mapungubwe from the South African government. Her work continues to influence both chemistry curricula across Southern Africa and ongoing clinical translation of photodynamic therapy.',
    ...
    },
    {
      ...
      pronouns: 'she/her',
      bio: 'Catherine Ngila is a Kenyan analytical chemist whose research applies nanotechnology to monitoring water pollutants in rivers and treatment systems across sub-Saharan Africa. Based at variously the University of Johannesburg, the Kenyatta University, and the African Academy of Sciences, she has developed sensor materials capable of detecting heavy metals and persistent organic pollutants at low concentrations. She has served as Acting Executive Director of the African Academy of Sciences and as a vocal advocate for African women in research and policy roles. Her work links analytical chemistry to public-health questions about access to safe water.',
    ...
    },
    {
      ...
      pronouns: 'he/him',
      bio: 'Aderemi Kuku was a Nigerian mathematician whose research focused on algebraic K-theory of orders, group rings, and non-commutative rings, contributing to the abstract machinery underlying topology and number theory. He held the chair in mathematics at the University of Ibadan, served as President of the African Mathematical Union, and led mathematics at the International Centre for Theoretical Physics in Trieste. He was instrumental in expanding mathematical research and graduate education across the continent, helping establish networks that connected African mathematicians to international research communities. He continued mentoring through retirement until his death in 2022.',
